...
- Explore how React applications are structured.  
- Learn how to create and manage **functional components**.  
- Understand the use of **React hooks** such as `useState` and `useEffect`.  
- Build a simple, responsive **landing page** using reusable UI elements.
...
```
git clone https://github.com/EdgarZerpaZG/sprint-5-react.git
```
